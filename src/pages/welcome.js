    ...
    <>
      ...
      <div className="flex w-full h-screen gap-4">
        ...
        <div className="p-4">
          ...
          <div className="w-full flex flex-wrap justify-end gap-4 py-4">
            <div className="rounded-lg w-60 bg-green-300 shadow-md shadow-gray-400 py-10">
            ...
            <div className="rounded-lg w-60 bg-blue-300 shadow-md shadow-gray-400 py-10">
              <p className="text-lg font-semibold text-white text-center">Total Issues</p>
              <p className="text-sm font-light text-white text-center">324</p>
            </div>
            <div className="rounded-lg w-60 bg-orange-300 shadow-md shadow-gray-400 py-10">
              <p className="text-lg font-semibold text-white text-center">Total Issues</p>
              <p className="text-sm font-light text-white text-center">324</p>
            </div>
          </div>
...
const SideBar = () => {
  return (
    <div class="w-60 h-full shadow-md bg-white px-1 mb-4" id="sidenavExample">
      <ul class="relative">
